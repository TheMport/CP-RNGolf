class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.shotText = this.add.text(10, 10, '', { fontSize: '16px', fill: '#FFF' });

    }

    update() {
        this.shotText.setText(`Shots: ${this.shotsTaken} Score: ${this.score} Accuracy: ${this.shotsTaken > 0 ? Math.round((this.score / this.shotsTaken) * 100) : 0}%`);
